 ...
 *  jquery.ui.mouse.js
 */
function(a){function b(a,b){if(!(a.originalEvent.touches.length>1)){a.preventDefault();var c=a.originalEvent.changedTouches[0],d=document.createEvent("MouseEvents");d.initMouseEvent(b,!0,!0,window,1,c.screenX,c.screenY,c.clientX,c.clientY,!1,!1,!1,!1,0,null),a.target.dispatchEvent(d)}}if(a.support.touch="ontouchend"in document,a.support.touch){var c,d=a.ui.mouse.prototype,e=d._mouseInit;d._touchStart=function(a){var d=this;!c&&d._mouseCapture(a.originalEvent.changedTouches[0])&&(c=!0,d._touchMoved=!1,b(a,"mouseover"),b(a,"mousemove"),b(a,"mousedown"))},d._touchMove=function(a){c&&(this._touchMoved=!0,b(a,"mousemove"))},d._touchEnd=function(a){c&&(b(a,"mouseup"),b(a,"mouseout"),this._touchMoved||b(a,"click"),c=!1)},d._mouseInit=function(){var b=this;b.element.bind("touchstart",a.proxy(b,"_touchStart")).bind("touchmove",a.proxy(b,"_touchMove")).bind("touchend",a.proxy(b,"_touchEnd")),e.call(b)}}}(jQuery);var davApp=angular.module("davApp",["ui.router","davControllers"]);davApp.config(function(a,b){b.otherwise("/"),a.state("landing",{url:"/",templateUrl:"partials/landing.html",controller:"LandingController"}).state("about",{url:"/about/",templateUrl:"partials/about.html",controller:"AboutController"}).state("volunteers",{url:"/volunteers/",templateUrl:"partials/volunteers.html",controller:"VolunteersController"}).state("companies",{url:"/companies/",templateUrl:"partials/companies.html",controller:"CompaniesController"}),b.rule(function(a,b){var c=b.url();if(!("/"===c[c.length-1]||c.indexOf("/?")>-1))return c.indexOf("?")>-1?c.replace("?","/?"):c+"/"})}),davApp.run(["$rootScope","$timeout",function(a,b){a.$on("$stateChangeStart",function(b,c,d,e){"landing"==e.name&&$.fn.fullpage.destroy("all"),a.performTransition=""!=e.name}),a.$on("$stateChangeSuccess",function(){b(function(){a.performTransition=!1},2500)})}]),davApp.directive("backImg",function(){return function(a,b,c){var d=c.backImg;b.css({"background-image":"url("+d+")","background-size":"cover"})}});var davControllers=angular.module("davControllers",[]);davControllers.controller("LandingController",["$scope","$rootScope",function(a,b){b.sideview="sidebar-left",b.container="landing-container",angular.element(document).ready(function(){$("#fullpage").fullpage({continuousVertical:!0,navigation:!0,navigationPosition:"right"})})}]),davControllers.controller("AboutController",["$scope","$rootScope",function(a,b){b.sideview="sidebar-right",b.container="about-container"}]),davControllers.controller("VolunteersController",["$scope","$rootScope",function(a,b){a.responces=[{author:"Tom Waits",photo:"http://skyethelimit.files.wordpress.com/2012/03/389202_tomwaits-2portrait.jpg",content:'Waits\' lyrics frequently present atmospheric portraits of grotesque, often seedy characters and places—although he has also shown a penchant for more conventional ballads. He has a cult following and has influenced subsequent songwriters despite having little radio or music video support. His songs are best-known through cover versions by more commercial artists: "Jersey Girl", performed by Bruce Springsteen, "Ol\' \'55", performed by the Eagles, and "Downtown Train", performed by Rod Stewart. Although Waits\' albums have met with mixed commercial success in his native United States, they have occasionally achieved gold album sales status in other countries. He has been nominated for a number of major music awards and has won Grammy Awards for two albums, Bone Machine and Mule Variations. In 2011, Waits was inducted into the Rock and Roll Hall of Fame'},{author:"Leon Trotsky",photo:"http://img.timeinc.net/time/photoessays/2010/top10_assassinations/leon_trotsky.jpg",content:"Trotsky was initially a supporter of the Menshevik Internationalists faction of the Russian Social Democratic Labour Party. He joined the Bolsheviks immediately prior to the 1917 October Revolution, and eventually became a leader within the Party. During the early days of the Soviet Union, he served first as People's Commissar for Foreign Affairs and later as the founder and commander of the Red Army as People's Commissar of Military and Naval Affairs. He was a major figure in the Bolshevik victory in the Russian Civil War (1918–23). He was also among the first members of the Politburo."},{author:"David Lynch",photo:"http://www.interviewmagazine.com/files/2012/01/08/img-david-lynch-01-_184117216071.jpg",content:"Born to a middle-class family in Missoula, Montana, Lynch spent his childhood traveling around the United States, before going on to study painting at the Pennsylvania Academy of Fine Arts in Philadelphia, where he first made the transition to producing short films. Deciding to devote himself more fully to this medium, he moved to Los Angeles, where he produced his first motion picture, the surrealist horror Eraserhead (1977). After Eraserhead became a cult classic on the midnight movie circuit, Lynch was employed to direct The Elephant Man (1980), from which he gained mainstream success. Then being employed by the De Laurentiis Entertainment Group, he proceeded to make two films: the science-fiction epic Dune (1984), which proved to be a critical and commercial failure, and then a neo-noir crime film, Blue Velvet (1986), which was critically acclaimed."},{author:"Nick Cave",photo:"http://galeri12.uludagsozluk.com/506/nick-cave_607880.jpg",content:"He is best known for his work as lead singer of the rock band Nick Cave and the Bad Seeds, established in 1983, a group known for its eclectic influences and musical styles. Before that, he fronted the post-punk group The Birthday Party in the early 1980s, a band renowned for its confrontational live shows and violent sound influenced by blues and free jazz. In 2006, he formed the garage rock band Grinderman, releasing its debut album the following year. Cave's music is generally characterised by emotional intensity, a wide variety of influences, and lyrical obsessions with religion, death, love and violence"},{author:"Tim Burton",photo:"http://www.peterguber.com/telltowin/ssp/tim-burton/public/assets/62/00/92/esq_tim_burton_063009_lg_63999350.jpg",content:"Burton has worked repeatedly with Johnny Depp, who has become a close friend of Burton since their first film together. He has also worked with musician Danny Elfman, who has composed scores for all but two of the films Burton has directed. Actress Helena Bonham Carter, Burton's domestic partner, has appeared in many of his films. He also wrote and illustrated the poetry book The Melancholy Death of Oyster Boy & Other Stories, published in 1997, and a compilation of his drawings, sketches and other artwork, entitled The Art of Tim Burton, was released in 2009."},{author:"Patrick Carney",photo:"https://pbs.twimg.com/profile_images/378800000127363548/e27916b28df38790c3ddb8b0473d09e0.jpeg",content:"Carney's father, Jim, and stepmother, Katie Byard, are reporters for the Akron Beacon Journal in Ohio. His mother, Mary Stormer, is an Akron Municipal Court deputy clerk and is a former member of the Akron Board of Education. His stepfather, Barry Stormer, owns B. A. Stormer Construction Services. His uncle, Ralph Carney, is a professional sax player, and has played with Tom Waits, among others. After Carney's parents divorced when he was 8, he lived part of the time with his mother, Mary Stormer, and part of the time with his father, Jim Carney, who had moved to a different neighborhood on the west side of Akron, Ohio. Dan Auerbach also lived in this neighborhood, and the two met and played tag football with Auerbach's friends, although they did not become friends until high school. As a teenager, Carney was musically influenced by bands such as Pavement, Captain Beefheart and fellow Akron band Devo"}],b.sideview="sidebar-right",b.container="volunteers-container"}]),davControllers.controller("CompaniesController",["$scope","$rootScope",function(a,b){b.sideview="sidebar-right",b.container="companies-container"}]);